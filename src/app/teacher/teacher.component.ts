...
export class TeacherComponent {
  ...
  readonly studentForm = new FormGroup({
    ...
    startdateValue: new FormControl(new TuiDay(2023, 0, 1)),
    enddateValue: new FormControl(new TuiDay(2023, 0, 1)),
  ...
  showDialog(): void {
    this.dialogs
      .open(new PolymorpheusComponent(NewTeacherComponent, this.injector), {})
      .subscribe();
  }
